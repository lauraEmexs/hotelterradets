...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/themes/adminlte/css/skins/skin-purple-light.min.css'); ?>">
...
<div class="login-box">
    <div class="login-logo">
        <a href="/"><b><?php echo config('App')->projectName; ?></b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <?php echo form_open('/admin/auth/login', ['class' => '', 'role'=>'form', 'method' => 'post']); ?>
